;(function(angular) {
    ...
    function CakeFlavors(){
        ...
        CakeFlavors.getFlavors = function(){
            return [
                {"name": 'Choclate', "cost": 0},
                {"name": 'German Cholacte', "cost": 0},
    ...
    function FrostingFlavors(){
        ...
        FrostingFlavors.getFlavors = function(){
            return [
                ...
                {"name": 'Choclate Buttercream', "cost": 0},
                {"name": 'Wipped', "cost": 0},
                {"name": 'Choclate Wipped', "cost": 0},
                {"name": 'Creamcheese', "cost": 0}
            ]
        }
